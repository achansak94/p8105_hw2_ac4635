...
Among the `r count(filter (NYC_transit_df, vending == "NO"))` subway entrances/exits without vending, `r count(filter(NYC_transit_df, ada == TRUE) %>% distinct(line, station_name))` allow allow entry. 
